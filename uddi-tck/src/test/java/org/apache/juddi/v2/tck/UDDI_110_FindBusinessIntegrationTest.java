...
public class UDDI_110_FindBusinessIntegrationTest {
     ...
     */
    @Test
    public void findBusinessByTModelBag() throws org.uddi.v2_service.DispositionReport {
        ...
        try {
            ...
            BusinessList bl = inquiry.findBusiness(fbb);
            int size = bl.getBusinessInfos().getBusinessInfo().size();
            if (size != 1) {
