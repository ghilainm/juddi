...
public class TckFindEntity {
    ...
    public void getNonExitingBusiness() {
        ...
        try {
            ...
            if (report == null) {
                //TODO don't know why but with weblogic the faultInfo from the DispositionReport is not used. Bug to fix most probably...
                String expectedMessage = "The business entity was not found for the given key:  " + nonExistingKey;
                assertTrue(e.getMessage().toLowerCase().equals(expectedMessage.toLowerCase()));
            } else {
