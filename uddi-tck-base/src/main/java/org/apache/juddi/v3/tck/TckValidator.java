...
public class TckValidator {
    ...
    private static final Log logger = LogFactory.getLog(TckValidator.class);
    ...
    public static void checkTransforms(TransformsType tTypes1, TransformsType tTypes2) {
        ...
        while (ttList1Itr.hasNext()) {
            ...
            try {
                ...
                //TODO check how this error can be better handled, at the moment it is ignored on purpose as I don't know how to fix it.
                logger.warn("An error occurred while comparing the transform content. It seems to be introduced by discrepancies between JAXB implementations, one adding an empty element at the end of the list." +
                        "The two content compared are '"+tx1.getContent()+"' and '"+tx2.getContent()+"'. The error was: "+throwable.getMessage());
            }
        }
    }
