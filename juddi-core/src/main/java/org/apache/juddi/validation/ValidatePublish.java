...
import org.apache.juddi.config.*;
...
import org.apache.juddi.v3.error.*;
                ...
                Tmodel modelTModel = null;
                {
                    ...
                    try {
                        ...
                        if (modelTModel == null) {
                            ...
                            TmodelCategoryBag categoryBag = modelTModel.getCategoryBag();
                            if (categoryBag != null) {
                                for (org.apache.juddi.model.KeyedReference ref : categoryBag.getKeyedReferences()) {
