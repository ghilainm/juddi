...
public class MappingModelToApi {
    ...
    public static void mapDiscoveryUrls(List<org.apache.juddi.model.DiscoveryUrl> modelDiscUrlList,
        ...
        for (org.apache.juddi.model.DiscoveryUrl modelDiscUrl : modelDiscUrlList) {
            ...
            try {
                ...
                Properties configurationProperties = getConfigurationProperties(configuration);
                String baseUrl = TokenResolver.replaceTokens(configuration.getString(Property.JUDDI_BASE_URL), configurationProperties);
                if (baseUrl == null) {
                ...
                baseUrl = TokenResolver.replaceTokens(configuration.getString(Property.JUDDI_BASE_URL_SECURE), configurationProperties);
                if (baseUrl == null) {
    ...
    public static Properties getConfigurationProperties(Configuration configuration) {
